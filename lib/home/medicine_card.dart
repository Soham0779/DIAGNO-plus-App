import 'package:NewsApp/database/repository.dart';
import 'package:NewsApp/model/pill.dart';
import 'package:NewsApp/notifications/notifications.dart';
  ...
  void _showDeleteDialog(BuildContext context, String medicineName, int medicineId, int notifyId) {
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                TextButton(style: ButtonStyle(backgroundColor: MaterialStateColor.resolveWith((states) => Theme.of(context).primaryColor.withOpacity(0.3)) ),
